  ...
  return (
    <main>
      <div className="left-sociallink">
        <ul>
          <li>
            <a href="https://github.com/bhakti199921/bhaktirane-html"  rel="noreferrer" target="_blank">
      ...
      <div className="container">
        ...
        <div className="experienced-section section" id="experience">
        ...
        <div className="getin-touched section">
          ...
          <a href="mailto:rbhakti12@gmail.com" className="btn btn-contact">Let's Connect</a>
        </div>
      </div>
    </main>
  );
